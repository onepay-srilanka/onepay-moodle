...
$instance = $DB->get_record('enrol', array('id'=>$enrolid, 'enrol'=>'onepay'), '*', MUST_EXIST);
...
$PAGE->set_url('/enrol/onepay/unenrolself.php', array('enrolid'=>$instance->id));
...
$message = get_string('unenrolselfconfirm', 'enrol_onepay', format_string($course->fullname));
