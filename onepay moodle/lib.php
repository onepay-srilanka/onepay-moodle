...
/**
 * onepay enrolment plugin implementation.
 */
class enrol_onepay_plugin extends enrol_plugin {
   ...
   /**
    ...
    public function get_currencies() {
        $codes = array('LKR','AUD', 'USD', 'CAD', 'EUR', 'GBP', 'NZD');
        $currencies = array();
        foreach ($codes as $c) {
    ...
    public function get_info_icons(array $instances) {
        return array(new pix_icon('icon', get_string('pluginname', 'enrol_onepay'), 'enrol_onepay'));
    }
    /**
    ...
    public function allow_unenrol(stdClass $instance) {
        // Users with unenrol cap may unenrol other users manually - requires enrol/onepay:unenrol.
        return true;
    }
    /**
    ...
    public function allow_manage(stdClass $instance) {
        // Users with manage cap may tweak period and status - requires enrol/onepay:manage.
        return true;
    }
    /**
    ...
    public function add_course_navigation($instancesnode, stdClass $instance) {
        if ($instance->enrol !== 'onepay') {
             throw new coding_exception('Invalid enrol instance type!');
        }

        $context = context_course::instance($instance->courseid);
        if (has_capability('enrol/onepay:config', $context)) {
            $managelink = new moodle_url('/enrol/onepay/edit.php',
    ...
    public function get_action_icons(stdClass $instance) {
        ...
        if (has_capability('enrol/onepay:config', $context)) {
            $editlink = new moodle_url("/enrol/onepay/edit.php",
                                       array('courseid' => $instance->courseid, 'id' => $instance->id));
    ...
    public function get_newinstance_link($courseid) {
        ...
        if (!has_capability('moodle/course:enrolconfig', $context) or !has_capability('enrol/onepay:config', $context)) {
            return null;
        }

        // Multiple instances supported - different cost for different roles.
        return new moodle_url('/enrol/onepay/edit.php', array('courseid' => $courseid));
    }
    /**
    ...
    public function enrol_page_hook(stdClass $instance) {
        ...
        if (abs($cost) < 0.00) {
            ...
            echo '<p>'.get_string('nocost', 'enrol_onepay').'</p>';
        } else {
            ...
            if (isguestuser()) {
                ...
                include($CFG->dirroot.'/enrol/onepay/enrol.html');
            }
    ...
    public function get_user_enrolment_actions(course_enrolment_manager $manager, $ue) {
        ...
        $params['ue'] = $ue->id;
        if ($this->allow_unenrol($instance) && has_capability("enrol/onepay:unenrol", $context)) {
        ...
        if ($this->allow_manage($instance) && has_capability("enrol/onepay:manage", $context)) {
    ...
    public function can_delete_instance($instance) {
        $context = context_course::instance($instance->courseid);
        return has_capability('enrol/onepay:config', $context);
    }
    /**
